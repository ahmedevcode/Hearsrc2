    ...
    return Container(
      padding: EdgeInsets.only(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(sender!=null?sender.toUpperCase():'', textAlign: TextAlign.start, style: TextStyle(fontSize: 13.0, fontWeight: FontWeight.bold, color: Colors.black, letterSpacing: -0.5)),
            SizedBox(height: 7.0),
